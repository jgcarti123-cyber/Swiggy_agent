...
- `your_go_to_items` — same `products[]`/`variations[]` shape as `search_products`, used for "Reorder my usuals" **and** as the "most ordered by you" signal cross-referenced into every guided search (see Pantry Pal section below).
